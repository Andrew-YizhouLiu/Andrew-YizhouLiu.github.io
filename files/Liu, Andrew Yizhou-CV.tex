...
``The Minimum Wage and Occupational Mobility'' (\emph{Accepted, International Economic Review})\\
...
\begin{tabularx}{\linewidth}{>{\hangindent=2em}X}
``The Short- and Medium-Run of Effect of Small and Large Minimum Wage Increases on Occupational Mobility''\\
``The Employment Effect of the Minimum Wage Under Unregulated Effort,'' Joint with Christine Braun and Peter Rupert\\
``Occupational Switching across Employment Status Over the Business Cycle''
\end{tabularx}
\end{rSection}
