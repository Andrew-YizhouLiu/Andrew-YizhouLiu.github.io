...
``The Large Volatility and the Slow Convergence of the Job-Finding Rate''\\
...
``The EITC and Occupational Mobility,'' \emph{Revision Requested, Journal of Public Economics}
\end{tabularx}
\end{rSection}
